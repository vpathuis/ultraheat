...
class HeatMeterResponse:
    ...
    def _match(self, name):
        ...
        if str_match:
            try:
                match UH50_REGEX_CONFIG[name]['type']:
                    case "float":
                    ...
                    case "datetime":
                        return datetime.datetime.strptime(str_match.group(1), UH50_REGEX_CONFIG[name]['format'])
            except ValueError:
                raise
    ...
    @property
    def volume_previous_year_m3(self) -> UH50_REGEX_CONFIG['volume_previous_year_m3']['type']:
        return self._match("volume_previous_year_m3")

    @property
    def heat_previous_year_gj(self) -> UH50_REGEX_CONFIG['heat_previous_year_gj']['type']:
    ...
    @property
    def measurement_period_minutes(self) -> UH50_REGEX_CONFIG['measurement_period_minutes']['type']:
    ...
    @property
    def power_max_previous_year_kw(self) -> UH50_REGEX_CONFIG['power_max_previous_year_kw']['type']:
    ...
    @property
    def flow_temperature_max_c(self) -> UH50_REGEX_CONFIG['flow_temperature_max_c']['type']:
        return self._match("flow_temperature_max_c")

    @property
    def flowrate_max_previous_year_m3ph(self) -> UH50_REGEX_CONFIG['flowrate_max_previous_year_m3ph']['type']:
        return self._match("flowrate_max_previous_year_m3ph")

    @property
    def return_temperature_max_c(self) -> UH50_REGEX_CONFIG['return_temperature_max_c']['type']:
        return self._match("return_temperature_max_c")

    @property
    def flow_temperature_max_previous_year_c(self) -> UH50_REGEX_CONFIG['flow_temperature_max_previous_year_c']['type']:
        return self._match("flow_temperature_max_previous_year_c")

    @property
    def return_temperature_max_previous_year_c(self) -> UH50_REGEX_CONFIG['return_temperature_max_previous_year_c']['type']:
    ...
    @property
    def fault_hours_previous_year(self) -> UH50_REGEX_CONFIG['fault_hours_previous_year']['type']:
    ...
    @property
    def settings_and_firmware(self) -> UH50_REGEX_CONFIG['settings_and_firmware']['type']:
