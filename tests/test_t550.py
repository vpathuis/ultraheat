...
class HeatMeterTest(unittest.TestCase):
    def assert_response_data(self, response_data):
        ...
        self.assertEqual(108.5, response_data.flow_temperature_max_previous_year_c)
        self.assertEqual(88.1, response_data.return_temperature_max_previous_year_c)
        self.assertEqual("01 00:00", response_data.monthly_set_day)
        self.assertEqual(datetime(2022, 6, 8, 10, 6, 51), response_data.meter_date_time)
        self.assertEqual(1.5, response_data.measuring_range_m3ph)
        self.assertEqual(
            "0 1 0 0017 CECV CECV 1 5.19 5.19 F 081008 040404 08 0 00 ?:",
